...
exports.TeamCollaborationTest = void 0;
const CompleteTeamProfiles_1 = require("../team/CompleteTeamProfiles");
const MemberTriggerSystem_1 = require("../team/MemberTriggerSystem");
...
class TeamCollaborationTest {
    constructor(mjos) {
        ...
        this.triggerSystem = new MemberTriggerSystem_1.MemberTriggerSystem();
        this.memoryManager = new MoxiaoyiMemoryManager_1.default(mjos);
    }
    /**
     * 运行完整的团队协作测试
     */
    async runFullTeamTest() {
     ...
     * 测试MCP工具
     */
    async testMCPTool(toolName, memberId) {
        try {
            switch (toolName) {
...
exports.TeamCollaborationTest = TeamCollaborationTest;
exports.default = TeamCollaborationTest;
//# sourceMappingURL=TeamCollaborationTest.js.map