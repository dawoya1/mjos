...
export type RoleType = 'architect' | 'designer' | 'developer' | 'tester' | 'product-manager' | 'devops' | 'specialist';
...
export type CollaborationMode = 'idle' | 'planning' | 'development' | 'collaboration' | 'review' | 'deployment';
...
export type MemoryEntryType = 'conversation' | 'project' | 'team' | 'role' | 'workflow' | 'insight' | 'lesson';
...
export type KnowledgeType = 'concept' | 'fact' | 'rule' | 'pattern' | 'procedure' | 'experience';
...
export type RelationshipType = 'is-a' | 'part-of' | 'related-to' | 'causes' | 'enables' | 'conflicts-with';
...
export type ReasoningType = 'deductive' | 'inductive' | 'abductive' | 'analogical' | 'causal' | 'probabilistic';
...
export type AgentType = 'reactive' | 'deliberative' | 'hybrid' | 'learning' | 'collaborative';
...
export type CapabilityType = 'perception' | 'reasoning' | 'planning' | 'execution' | 'communication' | 'learning';
...
export type AgentStatus = 'idle' | 'active' | 'busy' | 'learning' | 'error' | 'offline';
...
export type MessageType = 'request' | 'response' | 'notification' | 'broadcast' | 'query' | 'command';
